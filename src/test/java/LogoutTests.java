...
public class LogoutTests extends BaseTest{
    ...
    public void testLogOutAfterEmailUpdate() {
        ...
        profilePage.updateEmail("te$t$tudent2","sakthibala.sengottiyan+4@testpro.io");
    ...
    public void testLogOutAfterPasswordUpdate() {
        ...
        //Login using Email and Password
        loginPage.login("sakthibala.sengottiyan+4@testpro.io","te$t$tudent2");
    ...
    public void testLogOutAfterEmailPasswordUpdate() {
        ...
        //Login using Email and Password
        loginPage.login("sakthibala.sengottiyan+4@testpro.io","te$t$tudent1");
